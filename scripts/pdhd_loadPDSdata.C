...
void LowEnergyCLMatching_PDHD(){
    ...
    const double space_window = 1200; // window in Z and Y to check for isolated hits, cm
    ...
    int nfiles = 20;//filenames.size()
    for (int file_index = 0; file_index < nfiles; file_index++) {
        //cout << "pds vector size = " << pdsTimestamp.size() << endl; 
        cout << " " << endl;
        ...
        //charge_apa.push_back(3);
        //charge_t.clear();
        //charge_t.push_back(1.0e16*dt + 195.0*dtcrp);
        //charge_t.push_back(1.1e16*dt + 195.0*dtcrp);
        //charge_Z.clear();
        //charge_Z.push_back(35.0);
        //charge_Z.push_back(35.0);
        //charge_Y.clear();
        //charge_Y.push_back(275.0);
        //charge_Y.push_back(275.0);
        //charge_E.clear();
        //charge_E.push_back(1.0);
        //charge_E.push_back(1.0);
        //charge_nplanes.clear();
        //charge_nplanes.push_back(3);
        //charge_nplanes.push_back(3);
        ...
        //pdsTPC.push_back(2);
        //pdsX.clear();
        //pdsX.push_back(357.295655);
        //pdsX.push_back(357.295655);
        //pdsX.push_back(357.295655);
        //pdsY.clear();
        //pdsY.push_back(275.1595);
        //pdsY.push_back(275.1595);
	//pdsY.push_back(275.1595);
        //pdsZ.clear();
        //pdsZ.push_back(35.33625);
        //pdsZ.push_back(35.33625);
	//pdsZ.push_back(35.33625);
        //pdsChannel.clear();
        //pdsChannel.push_back(75);
        //pdsChannel.push_back(75);
	//pdsChannel.push_back(75);
        //pdsTimestamp.clear();
        //pdsTimestamp.push_back(1.0e16*dt);
        //pdsTimestamp.push_back(1.1e16*dt);
	//pdsTimestamp.push_back(1.3e16*dt);
        //pdsAmplitude.clear();
        //pdsAmplitude.push_back(80);
        //pdsAmplitude.push_back(80);
	//pdsAmplitude.push_back(80);
        ...
        //all_cluster_indices.push_back(cluster_indices); // For one PDS hit
